...
This directory contains files for setting up a Caddy docker container for **local tests only!**
 ...
 Simply run the [docker-compose file](docker-compose.yml) inside this directory to start caddy and access the web-app on [localhost:8080](http://localhost:8080).
